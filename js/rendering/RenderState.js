...
export default class RenderState {
    ...
    computeBlurFilterState(animationData, dataPosition) {
        const blurFilter = {
    ...
    computeDropShadowFilterState(animationData, dataPosition) {
    ...
    computeGlowFilterState(animationData, dataPosition) {
        const glowFilter = {
