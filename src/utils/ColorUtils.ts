...
export default class Colorutils {
    ...
    static ConvertFromEncodedColor(encodedColor: number) {
        // Helper function to convert unsigned byte to signed byte
        function fromUnsignedByte(byte: number) {
